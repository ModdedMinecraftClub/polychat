...
public class ClientStatusMessage extends AbstractMessage{
    protected static final short MESSAGE_TYPE_ID = 9;
    private final String serverID;
    private final short state;

    public ClientStatusMessage(String serverID, short state) {
        this.serverID = serverID;
        this.state = state;
    }

    public ClientStatusMessage(DataInputStream istream) throws IOException {
